...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>sdp</b> with <b>com.intuit.ssp:ssp-android</b> coordinates and
     * with version reference <b>sdp.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>splash</b> with <b>androidx.core:core-splashscreen</b> coordinates and
    ...
    /**
     * Dependency provider for <b>ssp</b> with <b>com.intuit.sdp:sdp-android</b> coordinates and
     * with version reference <b>sdp.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
    ...
    /**
     * Group of libraries at <b>kapt</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>roomDatabase</b> with <b>androidx.room:room-runtime</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getRoomDatabase() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.roomDatabase");
        }

        /**
         * Dependency provider for <b>roomDatabaseAnnotationProcessor</b> with <b>androidx.room:room-compiler</b> coordinates and
         * with version reference <b>room.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getRoomDatabaseAnnotationProcessor() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.roomDatabaseAnnotationProcessor");
        }

        /**
         * Dependency provider for <b>roomDatabaseAnnotationProcessor1</b> with <b>android.arch.persistence:room-compiler</b> coordinates and
         * with version reference <b>room.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getRoomDatabaseAnnotationProcessor1() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.roomDatabaseAnnotationProcessor1");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getRoomKtx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.roomKtx");
        }
        ...
        /**
         * Dependency provider for <b>viewModelSavedState</b> with <b>androidx.lifecycle:lifecycle-viewmodel-savedstate</b> coordinates and
         * with version reference <b>lifecycle.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getViewModelSavedState() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.viewModelSavedState");
        }
    ...
    public static class JetbrainsLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>coroutine.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutines() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("jetbrains.coroutines");
        }
    ...
    public static class KaptLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>viewModelAnnotationProcessor</b> with <b>androidx.lifecycle:lifecycle-compiler</b> coordinates and
         * with version reference <b>lifecycle.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getViewModelAnnotationProcessor() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kapt.viewModelAnnotationProcessor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>splash</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.coroutine</b>
         */
    ...
    public static class CoroutineVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutine.version</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class LifecycleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lifecycle.version</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class SdpVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>sdp.version</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
